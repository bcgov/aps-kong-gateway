local plugin_name = "runtime-group"
...
build = {
  ...
  modules = {
    ...
    ["kong.plugins."..plugin_name..".migrations.000_base_runtime_group"] = "kong/plugins/"..plugin_name.."/migrations/000_base_runtime_group.lua",
  }
}
